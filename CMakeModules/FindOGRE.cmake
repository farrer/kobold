...
find_path(OGRE_INCLUDE_DIR NAMES "OGRE/OgreRoot.h" HINTS ${OGRE_CONFIG_INCLUDE_DIR} ${OGRE_INC_SEARCH_PATH} ${OGRE_FRAMEWORK_INCLUDES} ${OGRE_PKGC_INCLUDE_DIRS} PATH_SUFFIXES "OGRE")
...
if (OGRE_INCLUDE_DIR)
  ...
  file(READ ${OGRE_INCLUDE_DIR}/OGRE/OgrePrerequisites.h OGRE_TEMP_VERSION_CONTENT)
