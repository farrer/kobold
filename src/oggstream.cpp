...
#ifdef __APPLE__
   #define KOBOLD_OGG_BUFFER_SIZE (4096 * 16) /**< Size of the Ogg Buffer */
#else
   #define KOBOLD_OGG_BUFFER_SIZE (4096 * 16) /**< Size of the Ogg Buffer */
#endif

#if KOBOLD_PLATFORM == KOBOLD_PLATFORM_IOS && KOBOLD_HAS_OGRE == 1
 ...
 *************************************************************************/
OggStream::OggStream()
          :SoundStream(SoundStream::TYPE_OGG, KOBOLD_OGG_BUFFER_SIZE)
{
}
