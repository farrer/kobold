...
bool SoundStream::stream(ALuint buffer, bool rw)
{
   ...
   while( (totalBytesReaded < bufferSize) && (!ended) )
   {
      ...
      {
         Log::add(Kobold::String("SoundStream::stream(): ") +
...
void SoundStream::check(Kobold::String where)
{
    ...
    {
        Log::add(Log::LOG_LEVEL_ERROR, "SoundStream: OpenAL error was raised!");
        switch(error)
        {
           case AL_INVALID_NAME: 
              Log::add("Invalid name parameter");
           break;
           case AL_INVALID_ENUM: 
              Log::add("Invalid parameter");
           break;
           case AL_INVALID_VALUE: 
              Log::add("Invalid enum parameter value");
           break;
           case AL_INVALID_OPERATION: 
              Log::add("Illegal call");
           break;
           case AL_OUT_OF_MEMORY: 
              Log::add("Unable to allocate memory");
           break;
        }
       Log::add(Kobold::String("At: ")+where);
    }
}
